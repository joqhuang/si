...
class TestCard(unittest.TestCase):
    def testCorrectCard(self):
        ace_of_spades = Card(suit=3, rank=1)
        four_of_diamonds = Card(suit=0,rank=4)
        self.assertEqual(ace_of_spades.suit,"Spades")
        self.assertEqual(ace_of_spades.rank,"Ace")
        self.assertEqual(ace_of_spades.rank_num,1)
        self.assertEqual(four_of_diamonds.suit,"Diamonds")
        self.assertEqual(four_of_diamonds.rank,4)
        self.assertEqual(four_of_diamonds.rank_num,4)
...
class TestDeck(unittest.TestCase):
    ...
    def testReplaceCard(self):
        testdeck = Deck()
        lastcard = testdeck.cards[-1]
        testdeck.pop_card
        testdeck.replace_card(lastcard)
        self.assertEqual(len(testdeck.cards),52)
        self.assertEqual(testdeck.cards[-1],lastcard)
